...
const navigation = [
  ...
  { name: 'Referrals', href: '/dashboard/referrals', icon: Gift, allowedRoles: ['super_admin', 'finance', 'support', 'analyst'] },
  { name: 'Onboarding', href: '/dashboard/onboarding', icon: BarChart3, allowedRoles: ['super_admin', 'analyst'] },
  { name: 'Geo Policy', href: '/dashboard/geo-policy', icon: Globe, allowedRoles: ['super_admin', 'analyst'] },
  { name: 'Legal & Policy', href: '/dashboard/legal-policy', icon: FileText, allowedRoles: ['super_admin', 'content', 'analyst'] },
  { name: 'Moderation', href: '/dashboard/moderator', icon: ShieldAlert, allowedRoles: ['super_admin', 'moderator', 'analyst'] },
  { name: 'Report Inbox', href: '/dashboard/content-reports', icon: Inbox, allowedRoles: ['super_admin', 'moderator', 'support', 'analyst', 'content'] },
  { name: 'Finance', href: '/dashboard/finance', icon: Wallet, allowedRoles: ['super_admin', 'finance', 'analyst'] },
  { name: 'Payment Incidents', href: '/dashboard/payment-incidents', icon: CreditCard, allowedRoles: ['super_admin', 'finance', 'support', 'analyst'] },
  ...
  { name: 'Clawback Debts', href: '/dashboard/clawback-debts', icon: HandCoins, allowedRoles: ['super_admin', 'finance', 'support', 'analyst'] },
  ...
  { name: 'Flash Drops', href: '/dashboard/flash-drops', icon: Zap, allowedRoles: ['super_admin', 'finance', 'support', 'analyst', 'moderator'] },
  { name: 'Spotlight', href: '/dashboard/spotlight', icon: Sparkles, allowedRoles: ['super_admin', 'moderator', 'support', 'analyst'] },
  { name: 'Reels', href: '/dashboard/reels', icon: Clapperboard, allowedRoles: ['super_admin', 'moderator', 'support', 'analyst'] },
  { name: 'Stories', href: '/dashboard/stories', icon: CircleDot, allowedRoles: ['super_admin', 'moderator', 'support', 'analyst', 'content'] },
  { name: 'Comments', href: '/dashboard/comments', icon: MessageSquare, allowedRoles: ['super_admin', 'moderator', 'support', 'analyst', 'content'] },
  { name: 'P2P Chats', href: '/dashboard/chats', icon: MessagesSquare, allowedRoles: ['super_admin', 'moderator', 'support', 'analyst'] },
  ...
  { name: 'Curations', href: '/dashboard/curations', icon: LayoutGrid, allowedRoles: ['super_admin', 'moderator', 'content', 'analyst'] },
  { name: 'Loyalty', href: '/dashboard/loyalty', icon: Coins, allowedRoles: ['super_admin', 'finance', 'support', 'analyst', 'content'] },
  { name: 'Audit Log', href: '/dashboard/audit', icon: History, allowedRoles: ['super_admin', 'analyst'] },
  { name: 'Feature Flags', href: '/dashboard/feature-flags', icon: Flag, allowedRoles: ['super_admin', 'analyst'] },
  { name: 'Experiments', href: '/dashboard/experiments', icon: FlaskConical, allowedRoles: ['super_admin', 'analyst'] },
  { name: 'Search AI', href: '/dashboard/search-embeddings', icon: BrainCircuit, allowedRoles: ['super_admin'] },
  { name: 'Observability', href: '/dashboard/observability', icon: Activity, allowedRoles: ['super_admin', 'analyst'] },
  { name: 'QA Hub', href: '/dashboard/safety-tests', icon: ShieldCheck, allowedRoles: ['super_admin', 'analyst'] },
]
